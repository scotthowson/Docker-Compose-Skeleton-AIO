...
handle_image_update() {
    ...
    _api_success "{\"success\": true, \"image\": \"$(_api_json_escape "$image_name")\", \"containers_restarted\": $restarted_json, \"containers_skipped\": $skipped_json, \"containers_failed\": $failed_json, \"timestamp\": \"$ts\"}"
}
